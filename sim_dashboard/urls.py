...
urlpatterns = patterns('',
    ...
    url(r'^view/get_collection_columns/(?P<pkid>\w+)/(?P<collection_name>\w+)/$', 'result_manager.views.get_collection_columns'),
    url(r'^view/get_statistics/(?P<pkid>\w+)/(?P<collection_name>\w+)/(?P<column_name>\w+)/$', 'result_manager.views.get_statistics'),
    url(r'^view/quick_look/(?P<pkid>\w+)/(?P<collection_name>\w+)/(?P<column_name>\w+)/$', 'result_manager.views.quick_look'),
